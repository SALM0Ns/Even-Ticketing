/**
 * Fix 12 Angry Men Show Dates V3
 * Properly adds show dates with date field to 12 Angry Men event
 */

const mongoose = require('mongoose');
const Movie = require('../models/Movie');

console.log('🔧 Fixing 12 Angry Men Show Dates V3...');
console.log('=====================================\n');

async function fix12AngryMenShowDatesV3() {
  try {
    // Connect to MongoDB
    ...
    // Create show dates (7 days from today) with proper date field
    console.log('\n📅 Creating show dates with date field...');
    ...
    // Update the event
    console.log('\n🔧 Updating event with proper show dates and showtimes...');
    await Movie.findByIdAndUpdate(eventId, {
      showDates: showDates,
      showtimes: showtimes
    });

    console.log('✅ Updated event with proper show dates and showtimes');
    ...
    console.log('\n📅 Show Dates:');
    updatedEvent.showDates.forEach((dateObj, index) => {
    ...
    console.log('\n🎯 Fix Results:');
    console.log('===============');
    console.log('✅ Show dates with date field added successfully');
